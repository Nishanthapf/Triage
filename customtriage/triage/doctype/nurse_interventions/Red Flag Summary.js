...
//     const vitalFields = ['temperature', 'pulse', 'respiration', 'saturation', 'height', 'weight', 'bmi', 'bmi_category','blood_pressure_mmhg','rbg_level','piccle','primary_diagnosis'];
...
const generateSummary = async () => {
  try {
    ...
    // Patient Details with fully customizable labels (editable)
    let patientInfo = `<div class="patient-info"><b>Patient Details:</b><ul class="summary-bullet-points">`;
    ...
    for (const [field, label] of Object.entries(patientMapping)) {
      if (currentRecord[field]) {
        patientInfo += `<li><b>${label}:</b> ${currentRecord[field]}</li>`;
      }
    }
    patientInfo += `</ul></div>`;

    // Physical Examination with fully customizable labels (editable)
    let vitalStats = `<div class="vital-stats"><b>Physical Examination:</b><ul class="summary-bullet-points">`;
    const vitalMapping = {
      ...
      rbg_level: "GRBS Level",
      piccle: "Piccle",
      primary_diagnosis: "Primary Diagnosis"
    };

    for (const [field, label] of Object.entries(vitalMapping)) {
      if (currentRecord[field] !== null && currentRecord[field] !== undefined && currentRecord[field] !== "") {
        vitalStats += `<li><b>${label}:</b> ${currentRecord[field]}</li>`;
      }
    }
    vitalStats += `</ul></div>`;

    let interventionDetails = ''; // Placeholder for future use
  ...
  try {
    ...
    const screeningDiabetesSummaryHtml = `
      <div class="screening-diabetes-summary">
        ...
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Screening for Diabetes Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const args = {
      ...
      fields: [
        ...
        'micro_albumin', 'lab_reports', 'if_no_please_update'
      ],
      limit_page_length: 0
    };
    ...
    const diabetesFollowupSummaryHtml = `
      <div class="diabetes-followup-summary">
        ...
        ${followupSummaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Diabetes Followup Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
...
const generateHypertensionSummary = async (currentRecord) => {
  try {
    ...
    const allFields = [
      ...
      'peripheral_pulsefeet', 'for_peripheral_edema', 'rft_last_oneyear', 'urine_albumin6', 'lab_scanning', 'if_no_please_update'
    ];
    ...
    const hypertensionSummaryHtml = `
      <div class="hypertension-summary">
        ...
        ${summaryContent}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Screening for Hypertension Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
...
const generateHypertensionFollowupSummary = async (currentRecord) => {
  try {
    ...
    const allFields = [
      ...
      'lipid_profile', 'micro_albumin', 'lab_reports', 'if_no_please_update'
    ];
    ...
    const hypertensionFollowupSummaryHtml = `
      <div class="hypertension-followup-summary">
        ...
        ${summaryContent}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Hypertension Follow up Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const abdominalPainGastrointestinalSummaryHtml = `
      <div class="abdominal-pain-gastrointestinal-summary">
        ...
        ${summaryContent}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Abdominal pain Gastrointestinal Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const diarrheaSummaryHtml = `
      <div class="diarrhea-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Diarrhea Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const vomitingSummaryHtml = `
      <div class="vomiting-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Vomiting Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const fatigueSummaryHtml = `
      <div class="fatigue-summary">
        <b>Fatigue Summary:</b>
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Fatigue Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const eyeProblemSummaryHtml = `
      <div class="eye-problem-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Eye Problem Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const backAndNeckPainSummaryHtml = `
      <div class="back-and-neck-pain-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Back and Neck Pain Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const legKneeHipPainSummaryHtml = `
      <div class="leg-knee-hip-pain-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Leg or Knee or Hip pain Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const dyspepsiaAciditySummaryHtml = `
      <div class="dyspepsia-acidity-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Dyspepsia/Acidity Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const footAnklePainSummaryHtml = `
      <div class="foot-ankle-pain-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Foot and Ankle Pain Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
...
const generateAnemiaAdolescentsSummary = async (currentRecord) => {
  try {
    ...
    const anemiaAdolescentsRecords = records.map((rec, idx) => ({
      ...
      recordNumber: idx + 1,
      creation: rec.creation,
      upload_report: rec.please_upload || ""  // Correct field
    }));
    ...
    const anemiaAdolescentsSummaryHtml = `
      <div class="anemia-adults-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Anemia - adults Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;

    return { anemiaAdolescentsSummaryHtml, redFlagsList, anemiaAdolescentsRecords };
  } catch (err) {
    console.error("Error in generateAnemiaAdolescentsSummary:", err);
    return {
      anemiaAdolescentsSummaryHtml: `<div class="anemia-adults-summary" style="color:red;">
...
//     const patient_id = currentRecord.patient_id || currentRecord.patient_unique_id || null;
//     const patient_name = currentRecord.patient_name || null;
//     const doctype = "Anemia - adults"; // Updated DocType name
...
//     // Optional: Validate fields against DocType metadata (safe fallback)
//     try {
//       const meta = await getFrappeDoc("frappe.client.get", { doctype: "DocType", name: doctype });
//       if (meta) {
//         const metaFields = meta.fields.map(f => f.fieldname);
//         validFields = allFields.filter(f => metaFields.includes(f) || ['name', 'creation', 'patient_id', 'patient_name'].includes(f));
//       }
//     } catch (e) {
//       console.warn("Could not fetch DocType metadata for field validation.");
//     }
...
//     const redFlagsHtml = redFlagsList.length
//       ? `<ul class="summary-bullet-points">${redFlagsList.map(flag => `<li>${flag}</li>`).join('')}</ul>`
//       : '<ul class="summary-bullet-points"><li>No red flags detected in Anemia records.</li></ul>';
...
//       if (rec.anaemic_individual && (rec.anaemic_individual === "Yes" || rec.anaemic_individual === true)) conditions.push("is <span class='danger'>diagnosed as anemic</span>");
//       if (rec.hb_morethan_7 && (rec.hb_morethan_7 === "Yes" || rec.hb_morethan_7 === true)) conditions.push("has hemoglobin greater than 7 g/dL");
//       if (rec.anemia_adolescents && rec.anemia_adolescents !== "0" && rec.anemia_adolescents !== "") conditions.push(`diagnosed with anemia: ${rec.anemia_adolescents}`);
//       if (rec.have_anemia && rec.have_anemia !== "0" && rec.have_anemia !== "") conditions.push(`reports anemia symptoms: ${rec.have_anemia}`);
//       if (rec.feeling_tired && (rec.feeling_tired === "Yes" || rec.feeling_tired === true)) conditions.push("has <span class='danger'>fatigue</span>");
//       if (rec.concentrate_work && (rec.concentrate_work === "Yes" || rec.concentrate_work === true)) conditions.push("has difficulty concentrating on work");
//       if (rec.have_you_attained_menarche && (rec.have_you_attained_menarche === "Yes" || rec.have_you_attained_menarche === true)) conditions.push("has attained menarche");
...
//       if (rec.slippers_regularly && (rec.slippers_regularly === "Yes" || rec.slippers_regularly === true)) conditions.push("wears slippers regularly");
//       if (rec.any_previous_lab && (rec.any_previous_lab === "Yes" || rec.any_previous_lab === true)) conditions.push("has previous lab reports");
//       if (rec.if_no_please_update && rec.if_no_please_update && rec.if_no_please_update.trim() !== "") conditions.push(`Note (No lab report): ${rec.if_no_please_update.trim()}`);
//       if (rec.none_anemia && (rec.none_anemia === "Yes" || rec.none_anemia === true)) conditions.push("reports no anemia symptoms");
...
//         <b>Anemia - adults Summary:</b>
//         ${summaryHtml}
//         <div class="red-flag-box"><b>Anemia - adults Red Flags:</b> ${redFlagsHtml}</div>
//       </div>
//     `;
  ...
  try {
    ...
    const anemiaChildrenSummaryHtml = `
      <div class="anemia-children-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Anemia-Children Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const headacheSummaryHtml = `
      <div class="headache-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Headache Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const pregnancyCareSummaryHtml = `
      <div class="pregnancy-care-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Pregnancy Care Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const postnatalCareSummaryHtml = `
      <div class="postnatal-care-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Postnatal Care Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const jaundiceSummaryHtml = `
      <div class="jaundice-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Jaundice Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const thyroidProblemSummaryHtml = `
      <div class="thyroid-problem-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Thyroid Problem Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const skinProblemSummaryHtml = `
      <div class="skin-problem-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Skin Problem Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const lymphNodeEnlargementSummaryHtml = `
      <div class="lymph-node-enlargement-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Lymph Node Enlargement Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
  ...
  try {
    ...
    const chestPainSummaryHtml = `
      <div class="chest-pain-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Chest Pain Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
...
//       if (rec.recent_dietory && rec.recent_dietory !== "0") conditions.push(`has <span class='danger'>recent dietary changes</span>`);
...
//         ${summaryHtml}
//         ${redFlagsHtml ? `<div class="red-flag-box"><b>Constipation Red Flags:</b> ${redFlagsHtml}</div>` : ''}
//       </div>
//     `;
...
const generateRespiratoryIssueSummary = async (currentRecord) => {
  try {
    ...
    records.forEach((rec, idx) => {
      ...
      // SpO2 red flag from currentRecord (Nurse Interventions)
    ...
    const redFlagsHtml = redFlagsList.length
      ? `<ul class="summary-bullet-points">${redFlagsList.map(flag => `<li>${flag}</li>`).join('')}</ul>`
      : '<ul class="summary-bullet-points"><li>No red flags detected in Respiratory Issue records.</li></ul>'; // <-- NEW: Safe default
    ...
    records.forEach((rec, idx) => {
      ...
      if (rec.respiratory_issue && rec.respiratory_issue !== "0" && rec.respiratory_issue !== "") conditions.push(`experiences respiratory issues`);
      ...
      if (rec.fever_since && rec.fever_since !== "0" && rec.fever_since !== "") conditions.push(`has had fever since ${rec.fever_since.toLowerCase()}`);
      if (rec.severity_fever && rec.severity_fever !== "0" && rec.severity_fever !== "") conditions.push(`rates fever severity as ${rec.severity_fever.toLowerCase()}`);
      if (rec.fever_most && rec.fever_most !== "0" && rec.fever_most !== "") conditions.push(`notes fever is most prominent ${rec.fever_most.toLowerCase()}`);
      if (rec.fever_withchills && rec.fever_withchills !== "0" && rec.fever_withchills !== "No" && rec.fever_withchills !== "") conditions.push(`has fever with chills`);

      if (rec.howlong_cough && rec.howlong_cough !== "0" && rec.howlong_cough !== "") conditions.push(`has had cough for ${rec.howlong_cough}`);
      ...
      if (rec.if_seasonal && rec.if_seasonal !== "0" && rec.if_seasonal !== "") conditions.push(`describes seasonal cough as ${rec.if_seasonal}`);
      if (rec.other_describe && rec.other_describe !== "0" && rec.other_describe !== "") conditions.push(`describes other cough details as ${rec.other_describe}`);
      if (rec.howis_cough && rec.howis_cough !== "0" && rec.howis_cough !== "") conditions.push(`describes cough as ${rec.howis_cough.toLowerCase()}`);
      if (rec.sputum_color && rec.sputum_color !== "0" && rec.sputum_color !== "") conditions.push(`reports sputum color as ${rec.sputum_color.toLowerCase()}`);
      ...
      if (rec.cold_sincewhen && rec.cold_sincewhen !== "0" && rec.cold_sincewhen !== "") conditions.push(`has had cold since ${rec.cold_sincewhen}`);
      if (rec.any_allergy && rec.any_allergy !== "0" && rec.any_allergy !== "") conditions.push(`reports allergies as ${rec.any_allergy}`);
      if (rec.coldother_describe && rec.coldother_describe !== "0" && rec.coldother_describe !== "") conditions.push(`describes other cold details as ${rec.coldother_describe}`);
      if (rec.nasal_congestion && rec.nasal_congestion !== "0" && rec.nasal_congestion !== "") conditions.push(`has nasal congestion described as ${rec.nasal_congestion.toLowerCase()}`);

      if (rec.since_headache && rec.since_headache !== "0" && rec.since_headache !== "") conditions.push(`has had headache since ${rec.since_headache}`);
      if (rec.headache_other && rec.headache_other !== "0" && rec.headache_other !== "") conditions.push(`describes other headache details as ${rec.headache_other}`);
      if (rec.severity && rec.severity !== "0" && rec.severity !== "") conditions.push(`rates headache severity as ${rec.severity.toLowerCase()}`);
      if (rec.when_feelpain && rec.when_feelpain !== "0" && rec.when_feelpain !== "") conditions.push(`feels headache pain ${rec.when_feelpain.toLowerCase()}`);
      ...
      if (rec.any_history_of_asthama && rec.any_history_of_asthama !== "0" && rec.any_history_of_asthama !== "") conditions.push(`has <span class='danger'>a history of asthma</span>`);
      if (rec.any_history_of_allergy && rec.any_history_of_allergy !== "0" && rec.any_history_of_allergy !== "") conditions.push(`has <span class='danger'>a history of allergies</span>`);
      if (rec.past_symptoms && rec.past_symptoms !== "0" && rec.past_symptoms !== "") conditions.push(`has past symptoms described as ${rec.past_symptoms.toLowerCase()}`);
      if (rec.history_asthma && rec.history_asthma !== "0" && rec.history_asthma !== "") conditions.push(`has <span class='danger'>a family history of asthma</span>`);
      if (rec.allergy_history && rec.allergy_history !== "0" && rec.allergy_history !== "") conditions.push(`has <span class='danger'>a family history of allergies</span>`);
      if (rec.throat_examination && rec.throat_examination !== "0" && rec.throat_examination !== "") conditions.push(`has throat examination findings as ${rec.throat_examination}`);
      if (rec.sinus_tenderness && rec.sinus_tenderness !== "0" && rec.sinus_tenderness !== "") conditions.push(`has sinus tenderness`);

      // LAB REPORT LOGIC (Fixed)
      if (rec.lab_previous && (rec.lab_previous === "Yes" || rec.lab_previous === true)) {
        conditions.push("has previous lab reports");
      }
      if (rec.if_yes_please_upload && rec.if_yes_please_upload !== "0" && rec.if_yes_please_upload !== "") {
        conditions.push("has uploaded a lab report");
      } else if (rec.if_no_please_update && rec.if_no_please_update.trim() !== "") {
      ...
      if (rec.none4 && (rec.none4 === "Yes" || rec.none4 === true)) conditions.push("reports no severe child symptoms");
      if (rec.none && (rec.none === "Yes" || rec.none === true)) conditions.push("reports no other symptoms");
    ...
    const respiratoryIssueSummaryHtml = `
      <div class="respiratory-issue-summary">
        ...
        ${summaryHtml}
        ${redFlagsHtml ? `<div class="red-flag-box"><b>Respiratory Issue Red Flags:</b> ${redFlagsHtml}</div>` : ''}
      </div>
    `;
...
<li>
  ...
  if (rec.uploadedReport && rec.uploadedReport !== "0") {
    fullRecordsHtml += `
<ul><li>
  <a class="pdf-link" href="${rec.uploadedReport}" target="_blank">
