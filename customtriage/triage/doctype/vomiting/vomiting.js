...
// === Age based red flag for vomiting.js ===
frappe.ui.form.on('Vomiting', {
...
function handle_age_based_sections(frm) {
    // Preferred column names for Vomiting doctype
    let child_column_name = 'red_flags_child';
    let adult_column_name = 'red_flags_adult';

    // List all child and adult fields (adjusted for Vomiting)
    const child_fields = [
        'child',
        'dehydration',
        'sever_dehydration',
    ...
    const adult_fields = [
        'adult',
        'if_vomiting_with_mild_dehydration',
        'if_vomiting_with_sever_dehydration_and_drowsiness',
        'blood_in_the_vomit',
        'none_vomiting'
    ];
